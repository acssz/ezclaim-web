...
const dict: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    payoutInfo: "Payment Information (Required only on first use)",
    payoutIban: "IBAN",
  ...
  "de-CH": {
    ...
    payoutInfo: "Zahlungsinformationen (Nur bei der ersten Nutzung erforderlich)",
    payoutIban: "IBAN",
  ...
  fr: {
    ...
    payoutInfo: "Informazioni di pagamento (Richieste solo al primo utilizzo)",
    payoutIban: "IBAN",
  ...
  it: {
    ...
    payoutInfo: "Informations de paiement (Requises uniquement lors de la première utilisation)",
    payoutIban: "IBAN",
